...
namespace RDPKeepAlive
{
    internal static partial class NativeMethods
    {
        ...
        /// <summary>
        /// Enumerates all top-level windows on the screen by passing their handles to a callback function.
        /// </summary>
        ...
        /// <param name="nMaxCount">Maximum number of characters to copy.</param>
        /// <returns>The length of the string copied, not including the terminating null character.</returns>
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
